...
```text
dist/v1.3.0/portable-<build-id>/Choicer Voicer Pack Creator/
dist/v1.3.0/Choicer-Voicer-Pack-Creator-1.3.0-Windows-x64.zip
```
...
The Windows application folder is written below `dist/v1.3.0/portable-<build-id>/`, with a
shareable `Choicer-Voicer-Pack-Creator-1.3.0-Windows-x64.zip` beside it. The first build downloads
