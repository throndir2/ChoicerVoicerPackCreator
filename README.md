...
```text
dist/v0.7.0/portable-<build-id>/Choicer Voicer Pack Creator/
dist/v0.7.0/Choicer-Voicer-Pack-Creator-0.7.0-Windows-x64.zip
```
...
The Windows application folder is written below `dist/v0.7.0/portable-<build-id>/`, with a
shareable `Choicer-Voicer-Pack-Creator-0.7.0-Windows-x64.zip` beside it. The first build downloads
