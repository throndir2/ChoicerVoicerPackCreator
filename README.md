...
- Keeps the latest **100 project edits** per open tab. Use **Ctrl+Z** to undo and
  **Ctrl+Y** or **Ctrl+Shift+Z** to redo outside text fields, which retain their native
  text undo/redo. **Project > Edit History** shows the history, restores a selected state,
...
```text
dist/v1.3.4/portable-<build-id>/Choicer Voicer Pack Creator/
dist/v1.3.4/Choicer-Voicer-Pack-Creator-1.3.4-Windows-x64.zip
```
...
The Windows application folder is written below `dist/v1.3.4/portable-<build-id>/`, with a
shareable `Choicer-Voicer-Pack-Creator-1.3.4-Windows-x64.zip` beside it. The first build downloads
